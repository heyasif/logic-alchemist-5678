...
const Payment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Remove expiryMonth and expiryYear before sending
    delete orderData.cardDetails.expiryMonth;
    delete orderData.cardDetails.expiryYear;
    ...
    try {
      ...
      console.error("Order submission error:", error.response || error.message);
    }
  };
