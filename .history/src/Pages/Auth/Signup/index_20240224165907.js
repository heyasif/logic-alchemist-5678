...
const Signup = () => {
  ...
  const handleSignUpSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        // Construct the user data here based on your API's expected format
        const postData = {
          name: {
        ...
        // Assuming '/users' is your signup API endpoint
        ...
        if (response.data) {
          // If your API returns the new user data, set it as the current user
        ...
        // Update your state to reflect any errors here
